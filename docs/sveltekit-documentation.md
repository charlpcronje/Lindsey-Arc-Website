...
| --- | ------------------------------------------------------ | ----- | ----- | --------- |
| 1   | ./10-getting-started/10-introduction.md                | 28    | 368   | 537       |
| 2   | ./10-getting-started/20-creating-a-project.md          | 26    | 171   | 244       |
| 3   | ./10-getting-started/30-project-structure.md           | 93    | 686   | 1091      |
| 4   | ./10-getting-started/40-web-standards.md               | 107   | 626   | 1112      |
| 5   | ./10-getting-started/meta.json                         | 4     | 5     | 10        |
| 6   | ./20-core-concepts/10-routing.md                       | 394   | 2098  | 3631      |
| 7   | ./20-core-concepts/20-load.md                          | 693   | 3823  | 6540      |
| 8   | ./20-core-concepts/30-form-actions.md                  | 505   | 2205  | 3849      |
| 9   | ./20-core-concepts/40-page-options.md                  | 212   | 1803  | 2581      |
| 10  | ./20-core-concepts/50-state-management.md              | 175   | 1117  | 1705      |
| 11  | ./20-core-concepts/meta.json                           | 4     | 5     | 10        |
| 12  | ./25-build-and-deploy/10-building-your-app.md          | 31    | 195   | 289       |
| 13  | ./25-build-and-deploy/20-adapters.md                   | 50    | 204   | 347       |
| 14  | ./25-build-and-deploy/30-adapter-auto.md               | 23    | 151   | 302       |
| 15  | ./25-build-and-deploy/40-adapter-node.md               | 261   | 1642  | 2435      |
| 16  | ./25-build-and-deploy/50-adapter-static.md             | 174   | 726   | 1089      |
| 17  | ./25-build-and-deploy/55-single-page-apps.md           | 64    | 341   | 499       |
| 18  | ./25-build-and-deploy/60-adapter-cloudflare.md         | 123   | 689   | 1146      |
| 19  | ./25-build-and-deploy/70-adapter-cloudflare-workers.md | 136   | 590   | 977       |
| 20  | ./25-build-and-deploy/80-adapter-netlify.md            | 119   | 821   | 1230      |
| 21  | ./25-build-and-deploy/90-adapter-vercel.md             | 183   | 1217  | 1818      |
| 22  | ./25-build-and-deploy/99-writing-adapters.md           | 61    | 361   | 540       |
| 23  | ./25-build-and-deploy/meta.json                        | 4     | 6     | 11        |
| 24  | ./30-advanced/10-advanced-routing.md                   | 288   | 1566  | 2532      |
| 25  | ./30-advanced/20-hooks.md                              | 274   | 1615  | 2538      |
| 26  | ./30-advanced/25-errors.md                             | 135   | 639   | 1046      |
| 27  | ./30-advanced/30-link-options.md                       | 129   | 982   | 1442      |
| 28  | ./30-advanced/40-service-workers.md                    | 151   | 872   | 1315      |
| 29  | ./30-advanced/50-server-only-modules.md                | 65    | 358   | 529       |
| 30  | ./30-advanced/65-snapshots.md                          | 35    | 272   | 395       |
| 31  | ./30-advanced/67-shallow-routing.md                    | 99    | 615   | 940       |
| 32  | ./30-advanced/70-packaging.md                          | 222   | 1797  | 2624      |
| 33  | ./30-advanced/meta.json                                | 4     | 4     | 9         |
| 34  | ./40-best-practices/05-performance.md                  | 103   | 1268  | 1747      |
| 35  | ./40-best-practices/07-images.md                       | 165   | 1531  | 2261      |
| 36  | ./40-best-practices/10-accessibility.md                | 90    | 701   | 1084      |
| 37  | ./40-best-practices/20-seo.md                          | 146   | 637   | 1167      |
| 38  | ./40-best-practices/meta.json                          | 4     | 5     | 10        |
| 39  | ./50-reference/10-configuration.md                     | 33    | 102   | 172       |
| 40  | ./50-reference/20-cli.md                               | 16    | 118   | 159       |
| 41  | ./50-reference/30-modules.md                           | 8     | 16    | 20        |
| 42  | ./50-reference/40-types.md                             | 158   | 518   | 968       |
| 43  | ./50-reference/meta.json                               | 4     | 4     | 9         |
| 44  | ./60-appendix/10-faq.md                                | 249   | 1766  | 2714      |
| 45  | ./60-appendix/20-integrations.md                       | 39    | 293   | 459       |
| 46  | ./60-appendix/30-migrating-to-sveltekit-2.md           | 164   | 1677  | 2561      |
| 47  | ./60-appendix/40-migrating.md                          | 200   | 1213  | 2010      |
| 48  | ./60-appendix/50-additional-resources.md               | 25    | 173   | 290       |
| 49  | ./60-appendix/60-glossary.md                           | 52    | 873   | 1071      |
| 50  | ./60-appendix/meta.json                                | 4     | 4     | 9         |
|     | Total                                                  | 6332  | 39469 | 62074     |


## Total Counts Across All Files. Tokenizer Used: NLTK's Punkt Tokenizer
- Total Lines: 6332
- Total Words: 39469
- Total AI Tokens: 62074
...
## File: 10-getting-started/meta.json
```json
{
...
## File: 20-core-concepts/meta.json
```json
{
	"title": "Core concepts"
}
...
## File: 25-build-and-deploy/meta.json
```json
{
...
## File: 40-best-practices/meta.json
```json
{
